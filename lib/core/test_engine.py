	...
	for i, entry in enumerate(roidb):
		...
		if cfg.FAST_RCNN.FAST_HEAD2_DEBUG:
			...
			for ind in range(10):
				...
				stage2_item = dict_all[im_name]['stage2_pred_boxes'][ind]
				cnt += 1
				ax.add_patch(
		...
		if i % 100 == 0 and i != 0:
			with open("/nfs/project/libo_i/IOU.pytorch/IOU_Validation/score_nms_2stage.json", 'w') as f:
