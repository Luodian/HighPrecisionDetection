...
def im_detect_all(model, im, box_proposals = None, timers = None, im_name_tag = None):
	...
	if cfg.FAST_RCNN.FAST_HEAD2_DEBUG:
		...
		dict_i['pred_boxes'] = stage1_pred_boxes.tolist()
		dict_i['keep'] = keep
...
def im_detect_bbox(model, im, target_scale, target_max_size, boxes = None, file_tag_path = None):
